...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "pruebas_at_localhost";
		$data["connName"] = "pruebas at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;4dm1n1str4d0r;;pruebas;;1"; //currently unused

		$this->_connectionsIdByName["pruebas at localhost"] = "pruebas_at_localhost";

		$data["connInfo"] = array();
		$data["ODBCUID"] = "root";
		$data["ODBCPWD"] = "4dm1n1str4d0r";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][2] = "4dm1n1str4d0r";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "pruebas";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=4dm1n1str4d0r;Database=pruebas;OPTION=3";
		// encription set
		...
		$connectionsData["pruebas_at_localhost"] = $data;
