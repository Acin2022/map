...
class tDAL
{
	var $tblpruebas_at_localhost__address_user;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "address_user", "varname" => "pruebas_at_localhost__address_user", "altvarname" => "address_user", "connId" => "pruebas_at_localhost", "schema" => "", "connName" => "pruebas at localhost");
	}
