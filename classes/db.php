...
class DB
{
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "pruebas_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "address_user", "varname" => "pruebas_at_localhost__address_user", "altvarname" => "address_user", "connId" => "pruebas_at_localhost", "schema" => "", "connName" => "pruebas at localhost");
		}
	}
